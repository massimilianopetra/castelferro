...
export default function TabellaConto({ item, onAdd10, onAdd, onRemove, onSet  }: { item: DbConsumazioniPrezzo[],onAdd10: (id: number) => void, onAdd: (id: number) => void, onRemove: (id: number) => void, onSet: (id: number) => void }) {
    ...
    return (
        <div className="z-0 md:text-base">
           ...
           <div className="z-0 p-1 mb-1 text-3xl font-semibold text-blue-800 rounded-lg bg-blue-50 text-end md:text-base">
            ...
            <TableContainer component={Paper}>
                <Table  sx={{ minWidth: 150 }} size="small" aria-label="a dense table">
                    ...
                    <TableBody >
                        {item.map((row) => (
                            <TableRow className="hover:bg-yellow-100 md:text-base" sx={{
