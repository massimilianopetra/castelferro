            ...
            <Table sx={{ minWidth: 450 }} aria-label="a dense table">
                <TableHead>
                    <TableRow>
                        ...
                        <TableCell className="font-bold text-xs sm:text-base" align="left">Percentuale</TableCell> 
                ...
                <TableBody>
                    {item.map((row) => (
                        <TableRow>
                            ...
                            <TableCell className="text-xs sm:text-base"align="left">{row.percentuale}</TableCell>
