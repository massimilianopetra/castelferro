...
function GetDay({i}:{i:number}) {
    if (i==1)
        ...
        return <h1 className="mb-4  font-extrabold text-gray-900 text-5xl "><span className="text-transparent bg-clip-text bg-gradient-to-r to-emerald-400 from-sky-200">VENERDI'</span></h1>
    else if (i==3)
        return <h1 className="mb-4  font-extrabold text-gray-900 text-5xl "><span className="text-transparent bg-clip-text bg-gradient-to-r to-emerald-400 from-sky-300">SABATO</span></h1>
     else if (i==4)
        return <h1 className="mb-4  font-extrabold text-gray-900 text-5xl "><span className="text-transparent bg-clip-text bg-gradient-to-r to-emerald-500 from-sky-300">DOMENICA</span></h1>
     else if (i==5)
        return <h1 className="mb-4  font-extrabold text-gray-900 text-5xl "><span className="text-transparent bg-clip-text bg-gradient-to-r to-emerald-500 from-sky-400">LUNEDI'</span></h1>
     else if (i==6)
        return <h1 className="mb-4  font-extrabold text-gray-900 text-5xl "><span className="text-transparent bg-clip-text bg-gradient-to-r to-emerald-600 from-sky-500">MARTEDI'</span></h1>
     else if (i==7)
        return <h1 className="mb-4  font-extrabold text-gray-900 text-5xl "><span className="text-transparent bg-clip-text bg-gradient-to-r to-emerald-600 from-sky-500">MERCOLEDI'</span></h1>
     else if (i==8)
        return <h1 className="mb-4  font-extrabold text-gray-900 text-5xl "><span className="text-transparent bg-clip-text bg-gradient-to-r  to-emerald-700 from-sky-600">GIOVEDI' the last dance</span></h1>
     else
        return <h1 className="mb-4  font-extrabold text-gray-900 text-5xl "><span className="text-transparent bg-clip-text bg-gradient-to-r to-red-500 from-purple-600">La sagra è già finita!</span></h1>
  }
